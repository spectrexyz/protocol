...
contract sERC721 is Context, AccessControlEnumerable, ERC721Burnable, ERC721Enumerable, ERC721Pausable, ERC721URIStorage {
    ...
    function mint(address to, string memory _tokenURI) external whenNotPaused {
